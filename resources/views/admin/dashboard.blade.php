    ...
    <div class="flex flex-col gap-8 mt-12">
        <div>
            <ul class="flex border-b mb-4" id="dashboardTabs" role="tablist">
                <li class="mr-2">
                    <button class="inline-block px-4 py-2 text-blue-600 border-b-2 border-blue-600 font-bold focus:outline-none"
                        id="transaksi-tab" data-tab="transaksi" type="button" role="tab" aria-controls="transaksi" aria-selected="true">
                        Transaksi
                    </button>
                </li>
                <li class="mr-2">
                    <button class="inline-block px-4 py-2 text-gray-600 border-b-2 border-transparent font-bold focus:outline-none"
                        id="produk-terlaris-tab" data-tab="produk-terlaris" type="button" role="tab" aria-controls="produk-terlaris" aria-selected="false">
                        Produk Terlaris
                    </button>
                </li>
            </ul>
