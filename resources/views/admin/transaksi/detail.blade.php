...
@section('content')
    ...
    <div class="flex flex-col justify-center items-center mb-4 mx-auto px-4">
        <div class="heading flex flex-col md:flex-row md:justify-between w-full gap-4 container px-4 mx-auto mb-8" data-aos="fade-up">
                ...
                <div class="flex flex-col md:flex-row md:justify-between mb-6 md:mb-9 gap-4" data-aos="fade-up">
                    ...
                    <div class="status_transaksi">
                        ...
                        @if ($data->status === 'pending')
                            <span class="py-2 px-4 md:py-3 md:px-5 bg-yellow-100 text-yellow-800 rounded-md text-sm md:text-base">Pending</span>
                        @elseif ($data->status === 'denied')
                            <span class="py-2 px-4 md:py-3 md:px-5 bg-red-100 text-red-800 rounded-md text-sm md:text-base">Denied</span>
                        @elseif ($data->status === 'waiting')
                            <span class="py-2 px-4 md:py-3 md:px-5 bg-blue-100 text-blue-800 rounded-md text-sm md:text-base">Waiting</span>
                        @elseif ($data->status === 'paid')
                            <span class="py-2 px-4 md:py-3 md:px-5 bg-green-100 text-green-800 rounded-md text-sm md:text-base">Paid</span>
                        @else
                            <span class="py-2 px-4 md:py-3 md:px-5 bg-gray-100 text-gray-800 rounded-md text-sm md:text-base">{{ ucfirst($data->status ?? 'Unknown') }}</span>
                        @endif
                    </div>
                </div>
