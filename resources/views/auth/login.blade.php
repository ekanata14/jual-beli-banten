...
<div class="flex justify-center items-center h-screen gap-8">
    <div class="order-2 lg:order-1 flex flex-col justify-start p-10 w-full h-full">
        <div class="logo flex justify-left items-center mb-10">
            <img src="../assets/icons/bhakti_logo.svg" alt="">
        </div>
        <!-- form section -->
        <div class="flex flex-col gap-15 px-0 md:px-15 my-auto">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5">
                ...
                <div class="flex flex-col">
                    ...
                    <a href="{{ route('forgot.password') }}" class="text-[#FF9D00] self-end">Lupa Password?</a>
                </div>
