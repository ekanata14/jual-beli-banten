...
@section('content')
    <div class="flex flex-col md:flex-row justify-center items-center gap-2 h-screen w-full px-4 overflow-y-auto">
        <div class="flex flex-col justify-center items-center gap-2 w-full md:w-1/2 mx-auto max-w-lg py-8">
            <div class="logo flex justify-center items-center">
                <img src="{{ asset('assets/icons/bhakti_logo.svg') }}" alt="logo" class="h-12 md:h-16">
            </div>
