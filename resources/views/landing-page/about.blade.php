...
<section class="home_hero hero flex w-full justify-start items-end h-[100vh]" data-aos="fade-up" data-aos-delay="100"
    ...
    <div class="home_hero_content py-9 px-10 w-full md:w-1/2" data-aos="fade-right" data-aos-delay="300">
        <h1 class="text-white" data-aos="fade-up" data-aos-delay="700">Melayani Kebutuhan Banten Modern dengan Sentuhan
            Tradisi
        </h1>
...
<section
    class="about_content w-full py-16 md:py-50 px-4 md:px-24 flex flex-col justify-center items-center gap-12 md:gap-50"
    data-aos="fade-up">
    ...
    <div class="about_image w-screen max-w-none h-56 md:h-[561px] bg-cover bg-center"></div>
    <div class="about_services_section w-full max-w-5xl" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="about_service_card_wrapper flex flex-col md:flex-row gap-5 mt-6 md:mt-9">
            <div class="about_service_card_item flex flex-col w-full md:w-1/4 p-5 items-start justify-between rounded-md h-48 md:h-64 bg-white"
                ...
                <p class="text-lg mb-2">01</p>
                <div class="">
                    <p class="text-black pb-2">Beragam Pilihan Banten</p>
                    <p>Mulai dari banten harian hingga upacara besar tersedia dalam satu platform.</p>
                </div>
            </div>
            <div class="about_service_card_item flex flex-col w-full md:w-1/4 p-5 items-start justify-between rounded-md h-48 md:h-64 bg-white"
                data-aos="fade-up" data-aos-delay="500">
                <p class="text-lg mb-2">02</p>
                <div class="">
                    <p class="text-black pb-2">Kualitas Terbaik</p>
                    <p>Setiap produk dibuat dengan bahan berkualitas tinggi oleh pengrajin berpengalaman.</p>
                </div>
            </div>
            <div class="about_service_card_item flex flex-col w-full md:w-1/4 p-5 items-start justify-between rounded-md h-48 md:h-64 bg-white"
                data-aos="fade-up" data-aos-delay="600">
                <p class="text-lg mb-2">03</p>
                <div class="">
                    <p class="text-black pb-2">Pesan Dengan Mudah</p>
                    <p>Proses pencarian, pemesanan, dan pembayaran yang sederhana dan cepat.</p>
                </div>
            </div>
            <div class="about_service_card_item flex flex-col w-full md:w-1/4 p-5 items-start justify-between rounded-md h-48 md:h-64 bg-white"
                data-aos="fade-up" data-aos-delay="700">
                <p class="text-lg mb-2">04</p>
                <div class="">
                    <p class="text-black pb-2">Pelestarian Budaya</p>
                    <p>Mendukung tradisi Bali dengan pendekatan modern yang praktis.</p>
                </div>
            </div>
        </div>
    </div>
