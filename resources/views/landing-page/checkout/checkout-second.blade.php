        ...
        <div class="checkout_form informasi_penerima_form">
            ...
            <form action="{{ route('cart.checkout.pengiriman.data') }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input type="number" name="id_transaksi" id="id_transaksi"
                        ...
                        placeholder="Masukan ID Transaksi" value="{{ old('id_transaksi') }}" required />
                </div>
                <!-- input id_order -->
                <div class="mt-4">
                    <label for="id_order">ID Order (Opsional)</label>
                    <input type="number" name="id_order" id="id_order"
                        class="block w-full p-4 ps-10 text-sm placeholder-gray-300 text-gray-900 border border-gray-50 rounded-lg bg-gray-50 focus:ring-amber-800 focus:border-broring-amber-800 mt-3"
                        placeholder="Masukan ID Order (Opsional)" value="{{ old('id_order') }}" />
                </div>
                <!-- input nama_penerima -->
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="alamat_penerima" id="alamat_penerima"
                        ...
                        value="{{ old('alamat_penerima', auth()->user()->pelanggan->alamat_pelanggan ?? '') }}" required
                        maxlength="250" />
                </div>
                <!-- input kota_penerima -->
                <div class="mt-4">
