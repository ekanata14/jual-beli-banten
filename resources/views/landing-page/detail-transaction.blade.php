        ...
        <div class="section_three mt-2 md:mt-2 bg-white rounded-md w-full px-10 py-10" data-aos="fade-up" id="biteship-shipping-info-{{ $pengiriman->id }}">
            <div class=" rounded-2xl mb-8 transition-all duration-300">
                ...
                <div id="biteship-data-{{ $pengiriman->id }}" class="hidden">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-2 pb-2">
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2 justify-self-end hidden">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div id="rating-modal-{{ $order->id }}"
                                class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black">
                                    ...
                                    <form action="{{ route('rating.store') }}" method="POST" class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea name="deskripsi_ulasan" rows="3"
                                                class="w-full border rounded px-2 py-1 focus:ring focus:ring-blue-100"
                                                placeholder="Tulis ulasan Anda..." required></textarea>
                                        </div>
                                        <div class="flex justify-end gap-2">
                                            <button type="button" onclick="closeRatingModal({{ $order->id }})"
