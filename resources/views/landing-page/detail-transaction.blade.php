...
@section('content')
    ...
    <div class="main_content py-10 px-4 md:py-40 md:px-36 flex flex-col justify-center items-center">
        ...
        <div class="transaction_container md:mt-10 md:mt-20 w-full md:w-11/12 flex flex-col rounded-lg" data-aos="fade-up">
            <!-- section 1 -->
                                    ...
                                    <div class="flex flex-col gap-4">
                                        @foreach ($pengiriman->orders as $order)
                                            ...
                                            <div id="rating-modal-{{ $order->id }}"
                                                ...
                                                <div
                                                    class="bg-white rounded-lg w-full max-w-md p-6 relative animate-fade-in">
                                                    <button
                                            ...
                                            @empty
                                                <div class="text-gray-500 text-center py-8">Tidak ada produk dalam transaksi
                                                    ini.</div>
                                            @endforelse
                                        </div>
                                    </div>
