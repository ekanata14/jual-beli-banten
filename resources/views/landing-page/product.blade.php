        ...
        <div class="product_search w-full flex flex-col gap-3 items-end">
            ...
            <form class="w-1/2">   
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-50 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Masukan Nama Produk" required />
                    <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-[#534538] hover:bg-[#36302c] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Cari Produk</button>
                </div>
            </form>
        </div>
    </section>
