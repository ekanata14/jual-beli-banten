    ...
    <header class="w-full fixed top-0 z-50 flex justify-center pt-4">
        <nav class="nav flex justify-between items-center bg-white bg-opacity-90 backdrop-blur fixed w-full px-4 md:px-8 lg:px-10 py-3 mt-4 shadow-md"
            ...
            <div id="navbar-menu" class="hidden lg:flex flex-1 justify-center items-center">
                <ul
                    class="nav-list flex flex-col lg:flex-row gap-6 lg:gap-[53px] bg-white lg:bg-transparent absolute lg:static top-full left-0 w-full lg:w-auto shadow-lg lg:shadow-none z-40 lg:z-auto px-6 py-4 lg:p-0
        ...
        <div id="fullscreen-menu"
            ...
            style="margin:0;">
            <button id="close-fullscreen-menu"
                class="absolute top-6 right-6 text-3xl text-gray-700 focus:outline-none"
                ...
                @if (auth()->check())
                    ...
                    <li>
                        <a href="{{ route('history') }}"
                            class="hover:text-blue-700 transition flex items-center gap-2"
                            onclick="closeFullscreenMenu()">
                            <svg class="w-6 h-6 text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('cart') }}" class="hover:text-blue-700 transition flex items-center gap-2"
                            onclick="closeFullscreenMenu()">
                            <img src="{{ asset('assets/icons/cart_icon.svg') }}" alt="Keranjang"
                                class="h-6 object-contain"
                                onerror="this.onerror=null;this.src='https://via.placeholder.com/24?text=Cart';">
                            <span>Keranjang</span>
                        </a>
            ...
            <div class="footer_contentTop flex flex-col md:flex-row md:justify-between md:items-start gap-8">
                ...
                <div class="footer_menu flex flex-col sm:flex-row gap-8 md:gap-16 w-full md:w-auto">
                    <ul class="footer_menu_left flex flex-col items-start mb-6 sm:mb-0" data-aos="fade-up"
                        data-aos-delay="300">
                        <li>
                            <p class="text-white text-sm mb-3 font-semibold">Menu</p>
                        </li>
                        <li class="mb-2"><a href="{{ route('home') }}" class="hover:underline">Beranda</a>
                        </li>
                        <li class="mb-2"><a href="{{ route('about') }}" class="hover:underline">Tentang
                                Kami</a>
                        </li>
                        <li class="mb-2"><a href="{{ route('product') }}" class="hover:underline">Produk</a>
                        </li>
                        <li class="mb-2"><a href="{{ route('cart') }}" class="hover:underline">Keranjang</a>
                        </li>
                        <li class="mb-2"><a href="#" class="hover:underline">Profil</a></li>
                    </ul>
                    <div class="footer_menu_right flex flex-col gap-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="footer_contactInfo mb-4 sm:mb-0">
                            <p class="text-white text-sm mb-3 font-semibold">Contact Us</p>
                            <h3 class="text-base break-all">Bhakti@gmail.com</h3>
                        </div>
                        <div class="footer_socialInfo">
                            <p class="text-white text-sm mb-3 font-semibold">Sosial Media</p>
