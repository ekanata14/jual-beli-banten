        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6" x-data="{ dropdownOpen: false }">
                <div class="relative" @click.away="dropdownOpen = false">
                    ...
                    <div x-show="dropdownOpen" x-transition class="absolute right-0 mt-2 w-48 rounded-md shadow-lg z-50 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div class="py-1">
