<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        <img src="{{ asset('assets/icons/bhakti_logo.svg') }}" alt="bhakti-logo">
                    </a>
                </div>
                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'owner')
                    <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard') || request()->routeIs('admin.dashboard.transaksi.filter') || request()->routeIs('admin.dashboard.best-seller') || request()->routeIs('admin.dashboard.best-seller.*')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                {{-- <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ Auth::guard('admin')->user()->nama }}</div> --}}
                {{-- <div class="font-medium text-sm text-gray-500">{{ Auth::guard('admin')->email }}</div> --}}
            </div>
